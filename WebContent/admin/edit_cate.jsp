    ...
    <div class="body">
        <div class="content">
            ...
            <div class="content-right">
                ...
                <form action="AdminServlet?method=doCates&operate=update" method="post" enctype="multipart/form-data">
                    <div class="content-right-form">
                        <div class="form-1">
                            <span>分类名称：</span>
                            <input type="hidden" name="cate_id" value="${param.cate_id }">
                            <input type="text" class="content-right-form-text" name="cate_name" value="${param.cate_name }"><br>
                        </div>
                        <div>
                        <!-- 
                        <div class="form-1">
                            <span>分类图片：</span>
                            <input type="file" class="file-update" name="cate_images" value="${param.cate_image }"><br>
                        </div>
                        -->
                        </div>
                        <div class="form-1">
                            <span>分类描述：</span><br>
                            <textarea class="cate-description"  cols ="100" rows = "30" name="cate_description">${param.cate_description }</textarea><br>
                        </div>
                        <div class="form-btns">
